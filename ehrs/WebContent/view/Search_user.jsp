			...
			<!--/down-->
							<div class="down">	
							   ...
							   <!--//down-->
								...
								<div class="menu">
									<ul id="menu" >
								<li id="menu-academico" ><a href="adminAddForm.jsp"><i class="fa fa-plus"></i> <span> Create User</span></a></li>
										<li id="menu-academico" ><a href="adminUpdateForm.jsp"><i class="fa fa-edit"></i> <span> Update User</span></a></li>
										<li id="menu-academico" ><a href="adminDeleteForm.jsp"><i class="fa fa-trash-o"></i> <span> Delete User</span></a></li>
