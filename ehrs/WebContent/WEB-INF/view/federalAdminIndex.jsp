		...
		<!-- header-starts -->
							...
							<div class="outter-wp">
								  ...
								  <!--//sub-heard-part-->
									<div class="graph-visual tables-main">
											<h2 class="inner-tittle">User Table</h2>
												<div class="graph">
			...
			<!--/sidebar-menu-->
				<div class="sidebar-menu">
					<header class="logo">
					<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="federalAdminIndex.jsp"> <span id="logo"> <h1>EHRs</h1></span> 
			...
			<!--/down-->
							<div class="down">	
									  <a href="federalAdminIndex"><img src="images/admin.jpg"></a>
									  <a href="federalAdminIndex"><span class=" name-caret">Admin Name</span></a>
