														 ...
														 <div class="block-page">
                                                                         ...
                                                                         <div class="set-1">
																			<div class="graph-2 general">
																				<h3 class="inner-tittle two">Create hospital  </h3>
																					<div class="grid-1">
																							<div class="form-body">
																									<form class="form-horizontal" action="createHospital" method="GET">
																									...
																									<div class="form-group">
																										...
																										<div class="col-md-8">
																											<div class="input-group">							
																												...
																												<input type="text" name="phoneNumber" class="form-control1 icon" placeholder="Phone Number">
																											</div>
																										</div>
																										<div class="col-sm-2">
																												<p class="help-block">erro displaying place</p>
																									...
																									<div class="form-group">
																										...
																										<div class="col-md-8">
																											<div class="input-group">							
																												...
																												<input type="text" name="website" class="form-control1 icon" placeholder="Website">
																											</div>
																										</div>
																										<div class="col-sm-2">
																												<p class="help-block">erro displaying place</p>
																									...
																									<div class="form-group">
																										...
																										<div class="col-md-8">
																											<div class="input-group">							
																												...
																												<input type="text" name="woreda" class="form-control1 icon" placeholder="Woreda">
																											</div>
																										</div>
																										<div class="col-sm-2">
																												<p class="help-block">erro displaying place</p>
