		...
		<div id="content">
			...
			<table>
				...
				<c:forEach var="tempUser" items="${users}">
					...
					<c:url var="updateLink" value="/user/userUpdateForm">
			...
			<!--/sidebar-menu-->
				<div class="sidebar-menu">
					<header class="logo">
					<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="hospitalAdmin"> <span id="logo"> <h1>EHRs</h1></span> 
