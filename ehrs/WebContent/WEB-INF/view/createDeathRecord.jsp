																							...
																							<div class="form-body">
																									...
																									<div class="form-group">
																										...
																										<div class="form-group">
																											...
																											<div class="col-sm-8">
																												<input type="text" class="form-control1" name="dateOfDeath" placeholder="Default Input">
																											</div>
																											<div class="col-sm-2">
																												<p class="help-block">erro displaying place</p>
																											</div>
																										...
																										<div class="form-group">
																											...
																											<div class="col-sm-8">
																												<input type="text" class="form-control1" name="funeralPlace" placeholder="Default Input">
																											</div>
																											<div class="col-sm-2">
																												<p class="help-block">erro displaying place</p>
																											</div>
																										...
																										<div class="form-group">
																											...
																											<div class="col-sm-8">
																												<input type="text" class="form-control1" name="funeralDate" placeholder="Default Input">
																											</div>
																											<div class="col-sm-2">
																												<p class="help-block">erro displaying place</p>
																											</div>
																										...
																										<div class="form-group">
																											...
																											<div class="col-sm-8">
																												<input type="text" class="form-control1" name="reasonForDeath" placeholder="Default Input">
																											</div>
																											<div class="col-sm-2">
																												<p class="help-block">erro displaying place</p>
																											</div>
