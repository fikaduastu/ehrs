									...
									<!--sub-heard-part-->
									  <div class="sub-heard-part">
									   <ol class="breadcrumb m-b-0">
											...
											<li class="active"> create stool form</li>
										</ol>
									   </div>
								  <!--//sub-heard-part-->
														 ...
														 <div class="block-page">
                                                                         ...
                                                                         <div class="set-1">
																			<div class="graph-2 general">
																					...
																					<div class="grid-1">
																							<div class="form-body">
																									<form class="form-horizontal"  action="addStoolForm" method="GET">
																										...
																										<div class="form-group">
																											<label for="focusedinput" class="col-sm-2 control-label">Direct Tool Exam</label>
																											<div class="col-sm-8">
																												<input type="text" class="form-control1" name="directToolExam" placeholder="Default Input">
																											</div>
																											<div class="col-sm-2">
																												<p class="help-block">erro displaying place</p>
																											</div>
																										...
																										<div class="form-group">
																											<label for="focusedinput" class="col-sm-2 control-label">Hpylori Stool Agent</label>
																											<div class="col-sm-8">
																												<input type="text" class="form-control1" name="hpyloriStoolAgent" placeholder="Default Input">
																											</div>
																											<div class="col-sm-2">
																												<p class="help-block">erro displaying place</p>
																											</div>
																										...
																										<div class="form-group">
																											<label for="focusedinput" class="col-sm-2 control-label">Occult Blood Cell</label>
																											<div class="col-sm-8">
																												<input type="text" class="form-control1" name="occultBloodCell" placeholder="Default Input">
																											</div>
																											<div class="col-sm-2">
																												<p class="help-block">erro displaying place</p>
																											</div>
																										...
																										<div class="form-group">
																											<label for="focusedinput" class="col-sm-2 control-label">Puss Cell</label>
																											<div class="col-sm-8">
																												<input type="text" class="form-control1" name="pusCell" placeholder="Default Input">
																											</div>
																											<div class="col-sm-2">
																												<p class="help-block">erro displaying place</p>
																											</div>
