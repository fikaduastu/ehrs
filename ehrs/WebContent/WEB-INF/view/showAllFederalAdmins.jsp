...
<link href="${pageContext.request.contextPath}/resources/css/font-awesome.css" rel="stylesheet"> 
	<!-- jQuery -->
<link href='${pageContext.request.contextPath}/resources///fonts.googleapis.com/css?family=Roboto:700,500,300,100italic,100,400' rel='stylesheet' type='text/css'>
	<!-- lined-icons -->
									...
									<!--sub-heard-part-->
									  <div class="sub-heard-part">
									   <ol class="breadcrumb m-b-0">
											...
											<li class="active">Show all federal admins</li>
										</ol>
									   </div>
								  <!--//sub-heard-part-->
									<script type="text/javascript">
$(document).ready(function(){
    ...
    $(".add-new").click(function(){
        ...
        var row = '<tr>' +
            '<td><input type="text" class="form-control" name="FirstName" id="fname"></td>' + '<td><input type="Email" class="form-control" name="Email" id="Email"></td>' + '<td><input type="phoneNumber" class="form-control" name="phoneNumber" id="phoneNumber" placeholder="+251 ...."></td>'+ '<td><input type="Website" class="form-control" name="Website" id="Website" placeholder="https://www"></td>'+
