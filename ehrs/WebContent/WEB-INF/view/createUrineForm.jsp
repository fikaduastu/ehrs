									...
									<!--sub-heard-part-->
									  <div class="sub-heard-part">
									   <ol class="breadcrumb m-b-0">
											...
											<li class="active"> create urine form</li>
										</ol>
									   </div>
								  <!--//sub-heard-part-->
														 ...
														 <div class="block-page">
                                                                         ...
                                                                         <div class="set-1">
																			<div class="graph-2 general">
																					...
																					<div class="grid-1">
																							<div class="form-body">
																									<form class="form-horizontal"  action="addUrineForm" method="GET">
																										...
																										<div class="form-group">
																											<label for="focusedinput" class="col-sm-2 control-label">Cast</label>
																											<div class="col-sm-8">
																												<input type="text" class="form-control1" name="cast" placeholder="Default Input">
																											</div>
																											<div class="col-sm-2">
																												<p class="help-block">erro displaying place</p>
																											</div>
																										...
																										<div class="form-group">
																											<label for="focusedinput" class="col-sm-2 control-label">Glucose</label>
																											<div class="col-sm-8">
																												<input type="text" class="form-control1" name="glucose" placeholder="Default Input">
																											</div>
																											<div class="col-sm-2">
																												<p class="help-block">erro displaying place</p>
																											</div>
																										...
																										<div class="form-group">
																											<label for="focusedinput" class="col-sm-2 control-label">Gram Stein</label>
																											<div class="col-sm-8">
																												<input type="text" class="form-control1" name="gramStein" placeholder="Default Input">
																											</div>
																											<div class="col-sm-2">
																												<p class="help-block">erro displaying place</p>
																											</div>
																										...
																										<div class="form-group">
																											<label for="focusedinput" class="col-sm-2 control-label">Ph</label>
																											<div class="col-sm-8">
																												<input type="text" class="form-control1" name="ph" placeholder="Default Input">
																											</div>
																											<div class="col-sm-2">
																												<p class="help-block">erro displaying place</p>
																											</div>
																										...
																										<div class="form-group">
																											<label for="focusedinput" class="col-sm-2 control-label">Uric Acid</label>
																											<div class="col-sm-8">
																												<input type="text" class="form-control1" name="uricAcid" placeholder="Default Input">
																											</div>
																											<div class="col-sm-2">
																												<p class="help-block">erro displaying place</p>
																											</div>
																										...
																										<div class="form-group">
																											<label for="focusedinput" class="col-sm-2 control-label">Wbc</label>
																											<div class="col-sm-8">
																												<input type="text" class="form-control1" name="wbc" placeholder="Default Input">
																											</div>
																											<div class="col-sm-2">
																												<p class="help-block">erro displaying place</p>
																											</div>
																									...
																									<div class="form-group">
																											<label for="focusedinput" class="col-sm-2 control-label">Wet Sweat</label>
																											<div class="col-sm-8">
																												<input type="text" class="form-control1" name="wetSweat" placeholder="Default Input">
																											</div>
																											<div class="col-sm-2">
																												<p class="help-block">erro displaying place</p>
																											</div>
